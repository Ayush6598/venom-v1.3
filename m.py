...
bot = telebot.TeleBot('7269270738:AAHgfDhuvOReDz6Pq8hcMQyvhuz7_KKPoys')
...
def add_user(message):
    ...
    if user_id in admin_id:
        ...
        response = "You have not purchased yet purchase now from:- @GOD_HACK_Z"
...
def clear_users_command(message):
    ...
    if user_id in admin_id:
        ...
        response = "ꜰʀᴇᴇ ᴋᴇ ᴅʜᴀʀᴍ ꜱʜᴀʟᴀ ʜᴀɪ ᴋʏᴀ ᴊᴏ ᴍᴜ ᴜᴛᴛʜᴀ ᴋᴀɪ ᴋʜɪ ʙʜɪ ɢᴜꜱ ʀʜᴀɪ ʜᴏ ʙᴜʏ ᴋʀᴏ ꜰʀᴇᴇ ᴍᴀɪ ᴋᴜᴄʜ ɴʜɪ ᴍɪʟᴛᴀ ʙᴜʏ:- @GOD_HACK_Z 🙇."
    bot.reply_to(message, response)
...
def handle_bgmi(message):
    ...
    if user_id in allowed_user_ids:
        ...
        response = ("🚫 Unauthorized Access! 🚫\n\nOops! It seems like you don't have permission to use the /bgmi command. DM TO BUY ACCESS:- @GOD_HACK_Z")
...
💥 /rules NO  : Please Check Before Use !!.
...
Buy From :- @GOD_HACK_Z
Official Channel :- https://t.me/+08jVFEvtpdkwOTQ1
'''
...
3. MAKE SURE YOU JOINED https://t.me/+08jVFEvtpdkwOTQ1 OTHERWISE NOT WORK
